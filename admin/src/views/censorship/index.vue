  ...
  <div class="app-container">
      ...
      <el-col :span="5">
        <el-card class="box-card">
          ...
          <div v-for="(o, index) in arr" :key="index" class="text item">
            <div :class="{ active: o.action }" @click="click_row(index)"> <el-button size="mini" type="text">{{ index+' '+ o.name }}</el-button> <el-button size="mini" type="text" @click="dialogVisible = true">导入</el-button> <el-button size="mini" type="text" :disabled="o.disabled" @click="startUsing">启用</el-button><el-button size="mini" type="text">配置</el-button></div>
          </div>
        </el-card>
      </el-col>
      <el-col :span="19">
        <div>
          ...
          <el-row v-for="(item, index) in arrTopic" :key="index" class="row_flag">
                  ...
                  <div class="maben_left">
                    ...
                    <div>
                      <el-checkbox-group v-model="item.checklist">
                        <p v-for="items in item.result" :key="items.index" :label="items.index">
    ...
    >
      <el-row>
        ...
        <el-row :gutter="20">
          <div v-for="(item,index) in creatArr.result" :key="index" class="row_falg">
            ...
            <el-col :span="4">
              <el-button v-if="index===0" type="primary" @click="addTopic"> 增加</el-button>
            </el-col>
            <el-col :span="4">
              <el-button v-if="index!==0" type="primary" @click="delTopic(index)"> 删除</el-button>
            </el-col>
          </div>
          <br>
        </el-row>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button v-if="!edit" type="primary" @click="sure">确 定</el-button>
        <el-button v-if="edit" type="primary" @click="editSure(creatArr.result)">编辑确定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
